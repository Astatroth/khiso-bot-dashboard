...
@section('content')
    <div class="row">
        <div class="col">
            <x-form.form :action="route('admin.content.manufacturer.save')" :files="true">
                @isset($entry?->id)
                ...
                <x-card.card>
                    <x-slot:body>
                        <div class="form-group row required">
                            <x-form.label for="manufacturer_name" class="col-md-3">
                                {{ __('Manufacturer name') }}
                            </x-form.label>
                            <div class="col-md-9">
                                <input type="text" name="manufacturer_name" id="manufacturer_name" class="form-control"
                                       value="{{ old('manufacturer_name') ?? $entry?->name }}" maxlength="255">
                            </div>
                        </div>
                    ...
                    <x-slot:footer>
                        <x-form.actions :back="route('admin.content.manufacturer.list')"/>
                    </x-slot:footer>
                </x-card.card>
            </x-form.form>
        </div>
