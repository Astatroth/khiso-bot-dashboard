...
use Mcamara\LaravelLocalization\Middleware\LocaleSessionRedirect as BaseMiddleware;

class LocaleSessionRedirect extends BaseMiddleware
{
    /**
    ...
    public function handle($request, Closure $next)
    {
        ...
        if (
            ...
            if ($request->is('login') && !isset($request->back_url)) {
                $redirection .= '?back_url='.urlencode(\URL::previous());
            }
